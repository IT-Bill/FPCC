...
LLVM_PROJECT_PATH=/fpcc
GSL_PREFIX=/fpcc/gslbuild
...
# libgsllinalg_SOURCE="cholesky.c hesstri.c inline.c luc.c ptlq.c balance.c exponential.c hh.c invtri.c mcholesky.c qr.c symmtd.c balancemat.c choleskyc.c hermtd.c householder.c lq.c multiply.c qrpt.c tridiag.c bidiag.c cod.c hessenberg.c householdercomplex.c lu.c pcholesky.c svd.c"
...
unzip() {
    rm -rf ./gsl-2.5 ./gslbuild
    tar -xzf gsl-2.5.tar.gz
}

configure_and_make() {
    ./configure --prefix=${GSL_PREFIX} CC=clang-3.9
    make -j4
}
...
compile_one_with_llvm_module() {
    ...
    set -x
    clang-3.9 -fPIC -DHAVE_CONFIG_H -I. -I.. -S -emit-llvm -g -o $ir_file $1
    opt-3.9 -S -load $MODULE_PATH -funcpass -debug-pass=Structure -o $ir_instructed_file $ir_file
    clang-3.9 -O2 -DHAVE_CONFIG_H -fPIC -DPIC -c -o $pic_file $ir_instructed_file
    clang-3.9 -O2 -DHAVE_CONFIG_H -fPIC -DPIC -c -o $nonpic_file $ir_instructed_file
    set +x
}
...
linking_libgslcblas() {
    ...
    # lo_files="$lo_files perturbator.lo fputil.lo handler.lo"
    lo_files="$lo_files fputil.lo handlers.lo"
