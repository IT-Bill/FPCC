...
void FPCCSanitizer::TwoSum(Instruction *I,
 ...
 // if(flag == 2){
 //   L3 = ConstantFP::get(Type::getDoubleTy(M->getContext()), 1.0);
 //   Err = IRB.CreateBinOp(Instruction::FAdd, L3, L2, "my_op");
 // }else{
...
void FPCCSanitizer::TwoMul(Instruction *I,
  ...
  //if(flag == 2){
  //  L3 = ConstantFP::get(Type::getDoubleTy(M->getContext()), 1.0);
  //  Err = IRB.CreateBinOp(Instruction::FAdd, L1, L3, "my_op");
  //}else{
  //  Err = IRB.CreateBinOp(Instruction::FAdd, L1, L2, "my_op");
  //}  
  LLVMContext &Ctx = M->getContext();
