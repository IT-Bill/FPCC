...
public:
    ...
    void printBriefInfo(int funcIndex) {
        std::cout<< std::setprecision(16)  << "2. Searching on Operations.\nFunction Index: " << funcIndex << ", ";
        std::cout<< std::setprecision(16)  << "Analyzing Operation: " << instID << ", OPCode: " << opcode << '\n';
        std::cout<< std::setprecision(16)  << "  Largest's input: " << std::setw(15) << std::scientific << topInputsEvolution[0].input << ", ";
        std::cout<< std::setprecision(16)  << "  Fitness: " << std::scientific << topInputsEvolution[0].fitness << '\n';
    }
};
...
private:
	...
	std::map<double, double> io;
        ...
        for (auto & i : inputsWithCountToEnd) {
            ...
            std::cout << std::setprecision(16) << std::scientific << i.fitness << "\t\t";
        ...
        for (const auto &kv : inputsWithCountToEnd) {
            myfile << "Data: ";
            myfile << 1000 << ", ";
            myfile << 1000 << ", ";
            myfile << std::setprecision(16) << std::scientific << kv.fitness << ", ";
            myfile << std::setprecision(16) << std::scientific << kv.input << ", ";
            myfile << std::setprecision(16) << std::scientific << funcUnderTest->callAndGetResult(kv.input) << ", ";
            myfile << (int)kv.fitness << ", ";
            myfile << kv.fitness << "\n";
        }
        myfile << "***************************************\n";
        myfile.close();
